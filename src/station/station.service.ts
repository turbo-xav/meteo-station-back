...
export class StationService {
  ...
  /**
    ...
    */
    ...
    public async switchresource(resource: string, switchOnOFF: SwitchState): Promise<void> {
        const response = await this.httpService.post(`${this.rootUrl}${this.resourcesUrl}${resource}`, { in: switchOnOFF.state === 'ON' }).toPromise();
        return response.data;
    }
     /**
